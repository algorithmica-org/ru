...
Данную статью писал сын шлюхи, я изза него 3 часа дебагал простенгькую задачу, нет что бы дать фул код на рабочее hld, этот хуесос дает нерабочий код на up, если у вас TL то напишите assert на up
