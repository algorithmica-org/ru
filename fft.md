...
Первым эту гипотезу опроверг Анатолий Карацуба. Его [алгоритм](https://algorithmica.org/ru/karatsuba) сводит умножение двух $n$-значиных чисел к трём умножениям $\frac{n}{2}$-значных чисел, что даёт оценку времени работы
...
```c++
// TODO: кто-нибудь законтрибьютите более быструю реализацию
```
