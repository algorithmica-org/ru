...
## Применения
> Даны две строки из символов 0 и 1 одинаковой строки $a$ и $b$, нужно найти такой циклический сдвиг вправо второй строки, что количество совпадающих соответствующих символов максимально
